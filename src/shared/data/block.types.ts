 ...
 *
 * The shape follows a follow-list row (`userId`, not `id`), minus the flags
 * that cannot mean anything here: a blocked account is invisible, so there is
 * no `isFollowing` to show, and blocking yourself is a 400.
 */
