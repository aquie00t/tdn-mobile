 ...
 * the typed calls promise an array. A proxy, an outage or a mis-shaped handler
 * can still put `null` — or an object — where the array belongs, and the type
 * says nothing about it at runtime.
 *
 ...
 * render, or at unmount, where it takes the whole screen down with it.
 *
 ...
 * @throws When it is not an array
 */
